<template>
  <div class="user-list-wrap">
    <el-form :inline="true" :model="state.formInline" class="demo-form-inline">
      ...
      <el-form-item label="钱包别名">
        <el-input v-model="state.formInline.user" placeholder="请输入钱包别名" />
      </el-form-item>
      <el-form-item label="钱包协议">
        <el-select v-model="state.formInline.user" placeholder="请选择钱包协议">
          <el-option label="Zone one" value="shanghai" />
          <el-option label="Zone two" value="beijing" />
        </el-select>
      </el-form-item>
      <el-form-item label="提币地址">
        <el-input v-model="state.formInline.user" placeholder="请输入提币地址" />
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog v-model="checkDia" title="添加" width="600px" center>
      <el-form :model="checkForm" ref="checkFormRef">
        ...
        <el-form-item prop="reason" label="钱包别名">
          <el-input v-model="checkForm.reason" placeholder="请输入钱包别名" />
        </el-form-item>
        <el-form-item prop="user" label="钱包币种">
          <el-input v-model="checkForm.user" style="width: 86px; margin-right: 20px" disabled />
          <el-select v-model="checkForm.user" placeholder="请选择钱包币种">
            <el-option label="Zone one" value="shanghai" />
            <el-option label="Zone two" value="beijing" />
          </el-select>
        </el-form-item>
        <el-form-item prop="reason" label="提币地址">
          <el-input v-model="checkForm.account" placeholder="请输入提币地址" />
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog v-model="infoDia" title="查看" width="30%">
      <el-form :model="infoForm" ref="infoFormRef" disabled>
        ...
        <el-form-item prop="reason" label="钱包别名">
          <el-input v-model="infoForm.reason" placeholder="请输入钱包别名" />
        </el-form-item>
        <el-form-item prop="user" label="钱包币种">
        ...
        <el-form-item prop="account" label="提币地址">
          <el-input v-model="infoForm.account" :rows="2" placeholder="请输入提币地址" />
        </el-form-item>
        <el-form-item prop="account" label="钱包协议">
          <el-input v-model="infoForm.account" :rows="2" placeholder="请输入钱包协议" />
        </el-form-item>
...
const state = reactive({
  ...
  columns: [
    ...
    { prop: 'name', label: '钱包别名' },
    { prop: 'mobile', label: '钱包币种' },
    { prop: 'email', label: '钱包协议' },
    { prop: 'nick', label: '提币地址' },
